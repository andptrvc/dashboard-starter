...
import { teacherSchema, TeacherSchemaFormType } from "@/lib/formValidationSchemas";
    ...
    <form
      ...
      <div className="flex justify-between flex-wrap gap-2">
        ...
        <div className="flex flex-col gap-2 w-full md:w-1/4">
          ...
          {errors.subjects?.message && <p className="text-sm text-red-400">{errors.subjects?.message.toString()}</p>}
        </div>
