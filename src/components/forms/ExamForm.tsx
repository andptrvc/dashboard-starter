...
import { examSchema, ExamSchemaFormType } from "@/lib/formValidationSchemas";
    ...
    <form
      ...
      <div className="flex justify-between flex-wrap gap-2">
        ...
        <div className="flex flex-col gap-2 w-full md:w-1/4">
          ...
          {errors.lessonId?.message && <p className="text-sm text-red-400">{errors.lessonId?.message.toString()}</p>}
        </div>
      </div>
