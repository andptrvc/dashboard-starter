              ...
              <div className="flex items-center justify-between gap-2 flex-wrap text-sm font-medium">
                ...
                <div className="flex items-center gap-2 w-full md:w-1/3 lg:w-full 2xl:w-1/3">
                  <Image
                    ...
                    height={14}
                  />
                  <span className="">{new Intl.DateTimeFormat("en-GB").format(teacher.birthday)}</span>
                </div>
                <div className="flex items-center gap-2 w-full md:w-1/3 lg:w-full 2xl:w-1/3">
                  <Image
                    src="/mail.png"
        ...
        <div className="bg-white p-4 rounded-md">
          ...
          <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
            <Link
              ...
              href={`/list/students?teacherId=teacher${2}`}>
              Teacher&apos;s Students
            </Link>
            <Link
            ...
            <Link
              ...
              href={`/list/exams?teacherId=teacher${2}`}>
              Teacher&apos;s Exams
            </Link>
            <Link
              className="p-3 rounded-md bg-lamaSkyLight"
              href={`/list/assignments?teacherId=teacher${2}`}>
